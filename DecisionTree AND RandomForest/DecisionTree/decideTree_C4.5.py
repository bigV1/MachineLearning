...
def firstTest():
	...
	cTree.loadDataSet(filename, labels)
	cTree.train()
	print(cTree.tree)
	plotTreeModel.createPlot(cTree.tree)

	# classify test
	vector = ['0','1','0','0'] #['0','1','0','0','no']
	result = cTree.predict(cTree.tree,labels,vector)
	print("true decision: no "," decideTree:",result)
